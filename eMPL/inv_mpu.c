...
//    0,    /* 1kHz. */
//    1,    /* 92Hz low pass filter*/
//    0,    /* 250dps. */
//    0x18,  /* Accel FSR setting = 2g. */
//    50,   //200ms stabilization time
//    5,    /* 200 samples */
//    10.f,  //20 dps for Gyro Criteria C
//    105.f, //Must exceed 60 dps threshold for Gyro Criteria B
//    .14f, //Must exceed +50% variation for Gyro Criteria A
//    .3f, //Accel must exceed Min 225 mg for Criteria B
//    .95f, //Accel cannot exceed Max 675 mg for Criteria B
//    .14f,  //Accel must be within 50% variation for Criteria A
...
int mpu_set_lpf(unsigned short lpf)
{
    ...
    if (i2c_write(st.hw->addr, st.reg->lpf, 1, &data))
		{
			data|=0x08;
			if (i2c_write(st.hw->addr, 0x1d, 1, &data))
        return -1;
		}
